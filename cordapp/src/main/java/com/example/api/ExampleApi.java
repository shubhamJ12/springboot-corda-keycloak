...
public class ExampleApi {
    ...
    @PUT
    @Path("create-iou")
    public Response createIOU(@QueryParam("iouValue") int iouValue,@QueryParam("attachmentHashValue") String attachmentHashValue,  @QueryParam("partyName") CordaX500Name partyName,@QueryParam("partyName2") CordaX500Name partyName2) throws InterruptedException, ExecutionException {
        if (iouValue <= 0) {
        ...
        final Party otherParty2 = rpcOps.wellKnownPartyFromX500Name(partyName2);
        if (otherParty == null) {
        ...
        try {
            final SignedTransaction signedTx = rpcOps
                    .startTrackedFlowDynamic(ExampleFlow.Initiator.class, iouValue, otherParty,attachmentHashValue,otherParty2)
                    .getReturnValue()
                    .get();
